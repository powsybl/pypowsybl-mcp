...
| `MCP_AUTH_TOKEN`     | *(unset)*   | Secret token protecting the admin tools (`set_session_id`, `duplicate_session`) and the admin HTTP API (`/admin/sessions`, see [Monitoring](monitoring.md)). If unset, both are disabled. |
